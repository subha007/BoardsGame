...
namespace BoardsGameUT
{
    ...
    /// </summary>
    [TestClass]
    public class AbaloneBoardFactoryUT
    {
        public AbaloneBoardFactoryUT()
        {
            //
        ...
        [TestMethod]
        public void AbaloneBoardObjectTest1()
        {
            string[] args = new string[8] { "-b", "abalone", "-pc", "250,250", "-r", "210", "-bb", "10" };
