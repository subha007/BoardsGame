...
namespace BoardsGame
{
    public class SVGStream : OutPutStream
    {
        ...
        public override void Initialize()
        {
            ...
            this.writer.AppendLine(@"<?xml-stylesheet href=""css/abalone-board.css"" type=""text/css""?>");
        ...
        public override void AddCircle(CCPoint2D cCPoint, double radius)
        {
        ...
        public override void AddPolygon(CCPoint2D[] cCPoints)
        {
